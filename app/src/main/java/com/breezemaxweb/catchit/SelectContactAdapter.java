...
/**
 * Created by BreezeMaxWeb on 2017-06-08.
 */
...
public class SelectContactAdapter extends BaseAdapter {
    ...
    public SelectContactAdapter(Context context, List<ContactInfo> clist) {
        mContext = context;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        view = inflater.inflate(R.layout.select_contact_each_item,null);
